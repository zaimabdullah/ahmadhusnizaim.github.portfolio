export const Bio = {
  name: 'Ahmad Husni Zaim Abdullah',
  roles: ['IT Student', 'Programmer'],
  description:
    'I am a motivated and versatile individual, always eager to take on new challenges. With a passion for learning I am dedicated to delivering high-quality results. With a positive attitude and a growth mindset, I am ready to make a meaningful contribution and achieve great things.',
  github: 'https://github.com/zaimabdullah',
  resume:
    'https://drive.google.com/file/d/1KzRml-VdXVSAMhyg2uIRa2nyxhpv44ur/view?usp=sharing',
  linkedin: 'https://www.linkedin.com/in/husnizaim/',
  twitter: 'https://twitter.com/zcreative14',
  insta: 'https://www.instagram.com/ah_z1997/',
  facebook: 'https://www.facebook.com/ahmadhusnizaim2/',
};
...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: 'Tailwind CSS',
        image:
          'https://d3mxt5v3yxgcsr.cloudfront.net/courses/7443/course_7443_image.jpg',
      },
    ],
  },
  {
    ...
    skills: [
      {
        name: 'PHP',
        image:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/121px-PHP-logo.svg.png',
      },
      {
        name: 'Laravel',
        image:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Laravel.svg/120px-Laravel.svg.png',
      },
      {
        name: 'Node Js',
      ...
      },
      {
        name: 'JSP',
        image:
          'https://miro.medium.com/v2/resize:fit:640/format:webp/1*wG7fTjpSBX0r2HLnuoWeAg.png',
      },
      {
        name: 'MySQL',
        image:
      ...
      },
      {
        name: 'Oracle',
        image:
          'data:image/png;base64,',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        name: 'Dart',
        image: 'https://avatars.githubusercontent.com/u/1609975?s=280&v=4',
      },
      {
        name: 'Android Studio',
        image:
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: 'Framer',
        image:
          'data:image/png;base64,',
      },
    ],
  },
];
...
export const experiences = [
  {
    ...
    desc: 'At DBK Tech Sdn Bhd, I play a key role in system development, debugging, and feature enhancements for web-based applications. I started by optimizing an HRMS system, addressing existing errors, and improving overall functionality to make it market-ready. Additionally, I developed a Subscription Module, allowing users to choose between monthly and yearly payments, integrating it with Billplz Payment Gateway for seamless transactions. Currently, I am leading the development of a Stockist Management System, which helps track purchases, sales, product batches, and profit distribution using a FIFO-based approach. Built with Yii2 Framework, Bootstrap 4, and MySQL, the system streamlines stockist investments and company-led product sales. With hands-on experience in full-stack development, database design, and system optimization, I continue to contribute to scalable and efficient web solutions.',
    skills: [
      'Yii2',
      'PHP',
      'JQuery',
  ...
  },
  {
    ...
    desc: "During my one-year tenure in the Protege Programme as a Junior Consultant in the Government Sales Division within Public Safety & Emergency Solutions, I had the opportunity to collaborate with a team involved in Malaysia's 999 emergency IT-related initiatives. Throughout this period, I contributed by creating flowcharts detailing emergency protocols based on provided data, which would be utilized for the development of new public safety and emergency software NG-999.",
    skills: [
      'Communication',
      'Teamwork',
      'Flowchart',
  ...
  },
  {
    ...
    desc: "As an IT Intern at TM's Department of Operational Batch Scheduling and Monitoring, I've worked with a team to monitor and schedule batch jobs using A-AUTO software. We ensured smooth operations, especially for billing and payment systems like Unifi, by promptly addressing any issues. This involved communication with A-AUTO personnel to resolve any failures and maintain uninterrupted job cycles.",
    skills: [
      'Communication',
      'Teamwork',
      'Familiarity with Batch Processing Concepts',
      'Knowledge of Batch Processing Tools',
  ...
  },
  {
    ...
    desc: 'As an IT Intern at Pejabat Pendaftar, UMK Bachok in Kelantan from May 2017 to August 2017, I gained valuable hands-on experience in web development. This internship was a requirement to complete my diploma during the final semester. During my tenure,  I actively participated in the development of a web application designed for booking meeting rooms. This experience not only enhanced my skills in web application development but also provided me with the opportunity to collaborate within a team environment.',
    skills: [
      'PHP',
      'Laravel',
      'Bootstrap',
...
export const education = [
  ...
  },
  {
    ...
    school: 'Universiti Teknologi MARA Campus Jasin, Melaka',
    date: 'Feb 2020 - Aug 2022',
    grade: '3.50 CGPA',
    desc: "I graduated with a Bachelor's degree in Information Systems Engineering from UiTM Campus Jasin in Melaka. Over five semesters, I maintained a CGPA of 3.50/4.00. My coursework covered a range of topics including Object-Oriented Requirements Analysis, Software Improvement, Object-Oriented Design and Implementation, Database Engineering, Java Programming, System Testing and Evolution, and Data Mining. Throughout my studies, I actively participated in group projects, collaborating with team members to tackle challenging assignments.",
    degree:
  ...
  },
  {
    id: 1,
    img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLIfK7LWfeJo9YYXVzP0sm8VYqvBj1fgwWmA&usqp=CAU',
    school: 'Universiti Teknologi MARA Campus Machang, Kelantan',
    date: 'Feb 2015 - Oct 2018',
    grade: '3.42 CGPA',
    desc: 'I completed my five-semester, diploma-level education at UiTM Campus Machang in Kelantan, where I majored in Computer Science.',
    degree: 'Diploma in Computer Science',
  },
  {
    id: 2,
    img: 'https://upload.wikimedia.org/wikipedia/ms/2/28/Sekolah_Menengah_Kebangsaan_%28A%29_Tangok.jpeg',
    school: 'Sekolah Menengah Kebangsaan Agama Tok Bachok, Kelantan',
    date: 'Jan 2010 - Dec 2014',
    grade: '3A 6B 2C SPM',
    desc: 'I completed my 5-year high school education at SMKA Tok Bachok in Kelantan, where I took the SPM examination in the engineering technology stream.',
    degree: 'PMR and SPM',
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    image:
      'https://github.com/user-attachments/assets/d257a07f-085c-48cf-98e0-d64f3977e027',
    tags: [
      'Flutter',
      'Isar Database',
      'Provider',
  ...
  },
  {
    ...
    image:
      'https://github.com/zaimabdullah/Find-a-Coach/assets/36534973/8ebad051-d13e-4a9e-9105-843ccbbf9e78',
    tags: ['Vue JS', 'Vue Router', 'VueX', 'Firebase'],
    category: 'web app',
  ...
  },
  {
    ...
    description:
      'Share a Place is a simple web application that gives user ability to get their current location on the map, get location based on address given and user can share the generated link to others. The web app was develop using HTML, CSS, and JavaScript while utilizing OpenLayers API for creating the map and OpenStreetMap(OSM) data to find locations on Earth by name, address (geocoding) and reverse geocoding. The web app is host under firebase hosting.',
    image:
      'https://github.com/zaimabdullah/Share-My-Place/assets/36534973/3a769b0c-85de-4545-8f24-2b9eb7cead98',
    tags: ['HTML5', 'CSS3', 'JavaScript', 'OpenLayers API', 'Firebase'],
    category: 'web app',
    github: 'https://github.com/zaimabdullah/Share-My-Place',
