export const Bio = {
  ...
  resume:
    'https://drive.google.com/file/d/1WLKNwrLp-xc3GUQgECq1fmk5Iih21Ke9/view?usp=sharing',
...
export const experiences = [
  {
    ...
    desc: 'Built and maintained enterprise web applications with **Java and Spring MVC**, working across MySiswaPlace, HACCP Management, and IICMS. Developed business workflows, RESTful API integrations, reporting dashboards, data visualizations, and database solutions while troubleshooting production issues and improving system reliability.',
    skills: [
      'Java',
      'Spring MVC',
      'JSP',
...
export const projects = [
  ...
  {
    id: 12,
    title: 'Cloud-Based HACCP Management System',
  ...
  {
    id: 11,
    title: 'Integrated Industrial Chemical Management System (IICMS)',
